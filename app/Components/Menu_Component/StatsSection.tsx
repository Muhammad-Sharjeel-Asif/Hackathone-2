        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              <img src="/icons/chef.svg" alt="Chef Icon" className="w-14 h-14 mb-4" />
            ...
            {/* Items Of Food */}
            <div className="flex flex-col items-center">
              <img src="/icons/food.svg" alt="Food Icon" className="w-14 h-14 mb-4" />
            ...
            {/* Years Of Experience */}
            <div className="flex flex-col items-center">
              <img src="/icons/experience.svg" alt="Experience Icon" className="w-14 h-14 mb-4" />
            ...
            {/* Happy Customers */}
            <div className="flex flex-col items-center">
              <img src="/icons/pizza.svg" alt="Pizza Icon" className="w-14 h-14 mb-4" />
